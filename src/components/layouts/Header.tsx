...
export const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40" style={{ marginTop: platform.isNative() ? '-4px' : '0' }}>
